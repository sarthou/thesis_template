...
% - laboratory
% - cotutelle
\title{\textbf{\large A long and complex title}}
\author{My NAME}
...
%% Boss
\nboss{2}
\makesomeone{boss}{2}{second BOSS}{}{}  % Sera affiche en second
\makesomeone{boss}{1}{first BOSS}{}{} % Sera afiche en premier
%% Referee
\nreferee{2}
...
%% Jury
\njudge{6}
\makesomeone{judge}{1}{first REFEREE}{Professeur}{Rapporteur}
\makesomeone{judge}{2}{second REFEREE}{Professeur Associ\'e}{Rapporteur}
\makesomeone{judge}{3}{first BOSS}{Directeur de Recherche}{Directeur de Thèse}
\makesomeone{judge}{4}{second BOSS}{Ing\'enieure de Recherche}{Directrice de Thèse}
\makesomeone{judge}{5}{first JUDGE}{Directeur de Recherche}{Président du Jury}
\makesomeone{judge}{6}{second JUDGE}{Professeure Associ\'ee}{Membre du Jury}
